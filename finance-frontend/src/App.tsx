...
function ProtectedApp() {
  ...
  const tabMeta = useMemo(() => ({
    ...
    budget: { label: 'Budget', icon: '🎯', section: 'Main', visible: true, locked: false, lockLabel: '' },
    chat: {
      label: 'AI Assistant',
      icon: '🤖',
      section: 'Main',
    ...
    import: { label: 'Import', icon: '⬆️', section: 'Finance', visible: true, locked: false, lockLabel: '' },
    tax: { label: 'Tax & GST', icon: '🧾', section: 'Finance', visible: true, locked: false, lockLabel: 'Upgrade to access' },
    health: { label: 'Health Score', icon: '💚', section: 'Finance', visible: true, locked: false, lockLabel: 'Upgrade to access' },
    audit: {
      label: 'Audit Log',
      icon: '📋',
      section: 'Workspace',
